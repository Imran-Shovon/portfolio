...
export function Contact() {
  ...
  const inputClass =
    "w-full rounded-xl px-4 py-3 text-sm outline-none transition-all duration-300 text-text placeholder-gray-500";
  const inputStyle = {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden -z-0 pointer-events-none">
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[180px] opacity-8"
          style={{ backgroundColor: "var(--color-accent-blue)", opacity: 0.06 }}
        />
      </div>
          ...
          <div ref={infoRef} className="lg:col-span-2 flex flex-col gap-6">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                interesting projects, or research collaborations. Let&apos;s
              ...
              {[
                {
                  icon: Mail,
                  label: "Email",
                  value: "shovonbiswas.cse@gmail.com",
                  color: "var(--color-accent-blue)",
                },
                {
                  icon: Phone,
                  label: "Phone",
                  value: "+880 1776752696",
