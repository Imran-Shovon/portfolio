  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden -z-0 pointer-events-none">
        <div
          className="absolute bottom-0 left-[-10%] w-[400px] h-[400px] rounded-full blur-[140px] opacity-10"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="relative pl-8 md:pl-12">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--color-accent-blue), var(--color-accent-purple), var(--color-accent-cyan))",
            }}
          />
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                    <div className="flex items-start gap-3">
                      <div
                        ...
                        style={{ backgroundColor: `${exp.accent}15` }}
                      >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.map((t) => (
                      <span
                        key={t}
                        className="px-2 py-1 text-xs rounded-md text-gray-400"
                        style={{
