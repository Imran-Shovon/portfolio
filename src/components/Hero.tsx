...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={blob1Ref}
        className="absolute -z-0 top-[5%] left-[-5%] w-[450px] h-[450px] rounded-full blur-[130px] opacity-25"
        style={{ backgroundColor: "var(--color-accent-blue)" }}
      />
      <div
        ref={blob2Ref}
        className="absolute -z-0 bottom-[10%] right-[-5%] w-[500px] h-[500px] rounded-full blur-[150px] opacity-20"
        style={{ backgroundColor: "var(--color-accent-purple)" }}
      />
      <div
        ref={blob3Ref}
        className="absolute -z-0 top-[50%] left-[40%] w-[300px] h-[300px] rounded-full blur-[120px] opacity-10"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 w-full">
        <div className="flex flex-col-reverse lg:flex-row items-start justify-between gap-16">
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            <h1
              ref={title1Ref}
              className="text-5xl font-bold leading-tight mb-2 text-white"
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(90deg, var(--color-accent-purple), var(--color-accent-cyan))",
            ...
            <p
              ref={descRef}
              className="text-base md:text-lg text-gray-400 max-w-xl mx-auto lg:mx-0 leading-relaxed mb-10"
            >
              Building premium digital experiences with a focus on seamless
              interactions, elegant UI, and robust technology. Passionate about
              crafting interfaces that inspire.
            </p>
          ...
          <div ref={profileRef} className="w-full lg:w-2/5 flex justify-center">
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[380px] lg:h-[380px]">
              ...
              <div className="absolute inset-3 rounded-full border border-purple-500/20 animate-[spin_18s_linear_infinite_reverse]">
                <div
                  className="absolute top-1/2 right-0 w-3 h-3 rounded-full translate-x-1/2 -translate-y-1/2"
                  style={{
              ...
              <div className="absolute inset-6 rounded-full border border-cyan-500/10 animate-[spin_25s_linear_infinite]">
                <div
                  className="absolute top-1/2 left-0 w-2 h-2 rounded-full -translate-x-1/2 -translate-y-1/2"
                  style={{
                    backgroundColor: "var(--color-accent-blue)",
                    boxShadow: "0 0 15px var(--color-accent-blue)",
                  }}
